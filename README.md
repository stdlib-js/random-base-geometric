...
```javascript
import geometric from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-geometric@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-geometric@v0.1.0-deno/mod.js';
```
